            ...
            val analyticsHandler = object : StringbootAnalyticsHandler {
                override fun onExperimentsAssigned(experiments: Map<String, ExperimentAssignment>) {
                    experiments.forEach { (key, assignment) ->
                        ...
                        StringbootLogger.i("Experiment: $key → ${assignment.variantName}")
                    }
                }
            }
    ...
    override fun onCreate() {
        ...
        if (success) {
            ...
            runBlocking {
                ...
                StringbootLogger.i("📦 Preloaded $locale strings into memory")
            }
            ...
            applicationScope.launch {
                ...
                StringbootLogger.i("🔄 Background sync complete for $locale")
            }
        } else {
...
```
I/Stringboot: ✅ Stringboot initialized successfully
I/Stringboot: 📦 Preloaded en strings into memory
I/Stringboot: 🔄 Background sync complete for en
```
...
// I/Stringboot: 📊 Experiment: cta-test → variant-a
```
