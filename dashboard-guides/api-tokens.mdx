...
<Tabs>
  <Tab title="Standard Token">
    ...
    **Features:**
    ...
    - Full API access
    - Long-lived or time-limited

    **Example:**
    ```javascript
    await StringBoot.initialize({
      apiToken: 'std_1a2b3c4d5e6f...',
...
<CardGroup cols={2}>
  ...
  <Card title="Use Plugin Type Wisely" icon="plug">
    Only use Plugin tokens for:
    - Browser-based integrations
    - CORS is genuinely required
    - Never for server-side apps
  </Card>
