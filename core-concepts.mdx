...
<Steps>
  <Step title="Layer 1: In-Memory Cache" stepNumber={1}>
    LRU, 1000 entries by default  `Access: <1ms `

    <Icon icon="arrow-down-from-line" iconType="solid" color="#00C853" /> Cache miss
  </Step>
  <Step title="Layer 2: Local Database">
    IndexedDB / Room / CoreData

    <Icon icon="arrow-down-from-line" iconType="solid" color="#00C853" /> Not Found
  </Step>
  <Step title="Layer 3: Network Sync">
